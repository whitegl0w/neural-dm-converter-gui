...
import glob
import torch
import depthmap.midas_sources.utils as utils
import argparse
import time
...
from depthmap.midas_sources.midas.model_loader import default_models, load_model
...
def process(device, model, model_type, image, input_size, target_size, optimize, use_camera):
    ...
    if "openvino" in model_type:
        ...
        if optimize and device == torch.device("cuda"):
            if first_execution:
                print("  Optimization to half-floats activated. Use with caution, because midas like Swin require\n"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--height',
                        ...
                        help='Preferred height of images feed into the encoder during inference. Note that the '
                             ...
                             '32 takes place. Many midas support only the height chosen during training, which is '
