...
def patch_embed_forward(self, x):
    """
    Modification of timm.midas.layers.patch_embed.py: PatchEmbed.forward to support arbitrary window sizes.
    """
    x = self.proj(x)
    if self.flatten:
...
def _get_rel_pos_bias(self, window_size):
    """
    Modification of timm.midas.beit.py: Attention._get_rel_pos_bias to support arbitrary window sizes.
    """
...
def attention_forward(self, x, resolution, shared_rel_pos_bias: Optional[torch.Tensor] = None):
    """
    Modification of timm.midas.beit.py: Attention.forward to support arbitrary window sizes.
    """
    B, N, C = x.shape
...
def block_forward(self, x, resolution, shared_rel_pos_bias: Optional[torch.Tensor] = None):
    """
    Modification of timm.midas.beit.py: Block.forward to support arbitrary window sizes.
    """
...
def beit_forward_features(self, x):
    """
    Modification of timm.midas.beit.py: Beit.forward_features to support arbitrary window sizes.
    """
